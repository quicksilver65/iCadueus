...
@property (nonatomic, strong) NSArray *providerResults;
...
-(void) viewWillAppear:(BOOL)animated{
    self.providerResults=[MedicalProvider GetFavorites];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:[NSString stringWithFormat:@"%@ %@", mp.FirstName, mp.LastName]
                                         ...
                                         destructiveButtonTitle:nil
                                              otherButtonTitles:@"Remove Favorite", @"Call", @"Directions", nil];
...
- (void)actionSheet:(UIActionSheet *)actionSheet didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    ...
    {
        [MedicalProvider RemoveFavorite:self.selectedProvider];
        self.providerResults=[MedicalProvider GetFavorites];
        [self.tableView reloadData];
    }
